...
def fetch_categories():
    ...
    try:
        ...
        cursor.execute("SELECT * FROM tbl_category where Cat_status=1")
...
def validate_subcategory(subcat_name, subcat_desc):
    ...
    if not re.match(desc_pattern, subcat_desc):
        return "Subcategory description must be 1-90 characters long and can contain letters, numbers, spaces, and punctuation. No leading/trailing spaces."
    return None

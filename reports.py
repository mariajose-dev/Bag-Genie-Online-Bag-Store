...
def generate_pdf_report(report_type, start_date, end_date):
    ...
    company_name = "<b>Bag Genie</b>"
    company_address = (
        "Orient Square, Kadavanthra Junction, Kadavanthra, Kochi,<br/>"
        "Ernakulam, Kerala 682020<br/>"
        "Agrabah, AG 12345"
    )
    company_phone = "<b>Phone:</b> +91 9755447896"
    company_email = "<b>Email:</b> info@baggenie.com"
    ...
    # Title
    title = Paragraph(f"{report_type} - Bag Genie", styles['Title'])
